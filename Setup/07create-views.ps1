# PowerShell Script to Create Razor Views
...
"@ | Out-File -FilePath "src\CloudMigrationTool.Web\Views\Shared\_Layout.cshtml" -Force -Encoding UTF8
...
"@ | Out-File -FilePath "src\CloudMigrationTool.Web\Views\_ViewStart.cshtml" -Force -Encoding UTF8
...
"@ | Out-File -FilePath "src\CloudMigrationTool.Web\Views\_ViewImports.cshtml" -Force -Encoding UTF8
...
"@ | Out-File -FilePath "src\CloudMigrationTool.Web\Views\Home\Index.cshtml" -Force -Encoding UTF8
...
"@ | Out-File -FilePath "src\CloudMigrationTool.Web\Views\Admin\Index.cshtml" -Force -Encoding UTF8
...
"@ | Out-File -FilePath "src\CloudMigrationTool.Web\Views\Admin\Connections.cshtml" -Force -Encoding UTF8

Write-Host "Creating Migration Views..." -ForegroundColor Cyan

# Migration Dashboard View
@"
@model MigrationDashboardViewModel
@{
    ViewData["Title"] = "Migration Overview";
}
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        ...
                        <h2 class="mb-0">@Model.InProgressJobs</h2>
                    </div>
                    <div class="ms-3">
                        <i class="fas fa-sync-alt fa-2x"></i>
                    </div>
        ...
        <div class="card bg-success text-white">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        <h5 class="card-title">Completed</h5>
                        <h2 class="mb-0">@Model.CompletedJobs</h2>
                    </div>
                    <div class="ms-3">
                        <i class="fas fa-check-circle fa-2x"></i>
                    </div>
        ...
        <div class="card bg-danger text-white">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-grow-1">
                        <h5 class="card-title">Failed</h5>
                        <h2 class="mb-0">@Model.FailedJobs</h2>
                    </div>
                    <div class="ms-3">
                        <i class="fas fa-exclamation-triangle fa-2x"></i>
                    </div>
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">Active Migration Jobs</h5>
            </div>
            <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (job.TotalItems > 0)
                                            {
                                                ...
                                                <small class="text-muted">@job.ProcessedItems / @job.TotalItems items</small>
                                            }
                                            else
                                            {
                                                <div class="progress" style="height: 20px;">
                                                    <div class="progress-bar progress-bar-striped progress-bar-animated" 
                                                         style="width: 100%">Initializing...</div>
                                                </div>
                                            }
                                        </td>
                                        <td>
                                            ...
                                            {
                                                <span class="text-muted">@job.StartedAt.Value.ToString("MMM dd, HH:mm")</span>
                                            }
                                        </td>
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                ...
                                                {
                                                    <form method="post" asp-action="Pause" asp-route-id="@job.Id" style="display: inline;">
                                                        <button type="submit" class="btn btn-outline-warning" title="Pause">
                                                            <i class="fas fa-pause"></i>
                                                        </button>
                                                    </form>
                                                }
                                                else if (job.Status == MigrationStatus.Paused)
                                                {
                                                    <form method="post" asp-action="Start" asp-route-id="@job.Id" style="display: inline;">
                                                ...
                                                <form method="post" asp-action="Cancel" asp-route-id="@job.Id" style="display: inline;">
                                                    <button type="submit" class="btn btn-outline-danger" title="Cancel"
                                                            onclick="return confirm('Are you sure you want to cancel this migration?')">
                ...
                else
                {
                    <div class="text-center py-4">
                        ...
                        <h5 class="text-muted">No active migrations</h5>
                        <p class="text-muted">All migration jobs are completed or stopped.</p>
                    </div>
                }
            </div>
        </div>
            ...
            <div class="card-body">
                @if (Model.RecentJobs.Any())
                {
                    <div class="list-group list-group-flush">
                        @foreach (var job in Model.RecentJobs.Take(5))
                        {
                            <div class="list-group-item d-flex justify-content-between align-items-start px-0">
                                <div class="ms-2 me-auto">
                                    <div class="fw-bold">
                                        <a asp-action="Details" asp-route-id="@job.Id">@job.Name</a>
                                    </div>
                    ...
                    <div class="text-center mt-3">
                        <a asp-action="Index" class="btn btn-sm btn-outline-primary">View All Jobs</a>
                    </div>
                }
                else
                {
                    <p class="text-muted text-center">No recent jobs found.</p>
                }
            </div>
        </div>
    </div>
...
"@ | Out-File -FilePath "src\CloudMigrationTool.Web\Views\Migration\Dashboard.cshtml" -Force -Encoding UTF8
...
"@ | Out-File -FilePath "src\CloudMigrationTool.Web\Views\Shared\_StatusBadge.cshtml" -Force -Encoding UTF8
...
"@ | Out-File -FilePath "src\CloudMigrationTool.Web\Views\Shared\_ConnectionStatusBadge.cshtml" -Force -Encoding UTF8
